                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Tambah Data Tagihan Rutin</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form  method="POST" action="{{url('/tagihan_rutin/tambah/')}}">
                                            @csrf
...
{{--                                            </div>--}}
                        ...
                        <h6 class="card-title" style="margin-bottom: 30px">Tagihan Pembayaran Rutin</h6>
